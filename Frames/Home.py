...
class Homepage(tk.Frame):
    def __init__(self, parent: tk.Tk, controller: tk.Tk):
        ...
        self.addbtn = tk.PhotoImage(file="images/addr.png")
        self.addbtn = self.addbtn.subsample(4, 4)
        self.addbtn_label = tk.Label(self.addbtn_frame, image=self.addbtn, bg="white", cursor="hand2")
       ...
       # self.dpbtn_label.pack(side="right", padx=10, pady=10)
        ...
        # flashcard frame
        self.flashcard_frame = tk.Frame(self, bg="white")
        ...
        for i in range(num_rows):
            for j in range(num_cols):
                ...
                if index < len(df):
                    ...
                    flashcard_widget = Flascard_widget(self.flashcard_frame, flashcard=flashcard_objet, controller=self.controller)
